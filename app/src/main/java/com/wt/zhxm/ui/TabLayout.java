...
//            Typeface typeface = Typeface.createFromAsset(context.getAssets(), "fonts/qxybxsj.ttf");
//            text.setTypeface(typeface);
    ...
    public static class Tab {
        ...
        public Tab(int imageResId, int textResId, int modeResId, Class<? extends ITabFragment> targetFragmentClz) {
            this.imageResId = imageResId;
            this.textResId = textResId;
            this.targetFragmentClz = targetFragmentClz;
